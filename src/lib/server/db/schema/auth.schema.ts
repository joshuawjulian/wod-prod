...
export const sessions = pgTable(
	...
	(t) => [unique('one_active_token_per_user').on(t.userId, t.valid)],
);

export const websiteRolesEnum = pgEnum('website_roles_enum', [
	'super',
	'admin',
	'user',
]);
...
export const websiteRoles = pgTable(
	...
	(t) => [
		primaryKey({ name: 'pk_website_roles', columns: [t.userId, t.role] }),
	],
);
